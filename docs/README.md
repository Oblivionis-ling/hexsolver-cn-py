...
| [`PACKAGING.md`](PACKAGING.md) | 0.6.2 Windows 单文件构建、成品验证、发布资产和专有文件边界。 |
...
| [`ocr/DATASET_GUIDE.md`](ocr/DATASET_GUIDE.md) | 本地 OCR 数据集采集与标注方法。 |
| [`research/README.md`](research/README.md) | 早期规则和开源路线调研索引。 |

`images/` 只保存最终、可公开、用于说明当前状态的界面证据；大量中间截图和本地 OCR 数据不进入 Git。
